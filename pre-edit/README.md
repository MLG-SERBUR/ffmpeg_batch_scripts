...
Results are saved here so they don't get lost in my source folder. Also, last time I attempted to have it automatically replace the original file, it randomly deleted it instead, so I'm not trying that again.