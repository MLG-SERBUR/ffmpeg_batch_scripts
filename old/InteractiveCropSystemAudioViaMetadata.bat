...
set /P left="Left crop: "
set /P right="Right crop: "
set /P top="Top crop: "
set /P bottom="Bottom crop: "
...
REM //////////////////// MAIN \\\\\\\\\\\\\\\\\\\\\\\\\
		...
		ffmpeg.exe -hide_banner -i %%x -c:v copy -bsf:v h264_metadata="crop_left=%left%:crop_right=%right%:crop_top=%top%:crop_bottom=%bottom%" -c:a copy -map_metadata 0 -map 0 -map -0:a:1 "%%~nx_output_Crop.%%~xx"
